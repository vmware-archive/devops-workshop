...
. Change the working directory to be _devops-workshop-boeing/labs/my_work/cloud-native-spring-ui_
+
...
*_STS Import Help_*
+
Select _File > Import…_. In the susequent dialog choose _Gradle > Existing Gradle Project_ then click the _Next_ button. In the _Import Gradle Project_ dialog browse to the _cloud-native-spring_ directory (e.g. _devops-workshop-boeing/labs/my_work/cloud-native-spring-ui_) then click the _Open_ button, then click the _Finish_ button.
