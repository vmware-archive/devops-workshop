...
. Edit the following file: */cloud-native-spring/p/build.gradle* Add the https://github.com/n0mer/gradle-git-properties[gradle-git-properties] plugin to your Gradle build. You must edit the file and add the plugin code below directly beneath the _buildscript{}_ block. The _gradle-git-properties_ adds Git branch and commit coordinates to the */info* endpoint:
+
[source, groovy]
---------------------------------------------------------------------
plugins {
