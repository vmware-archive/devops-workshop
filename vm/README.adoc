...
To simplify an attended installation, you may wish to employ the following Powershell https://git.web.boeing.com/fork-me/devops-setup/blob/master/full-kit/Full-Kit-Install.ps1[script].  Note that this script is currently in beta testing.  Use with caution.
